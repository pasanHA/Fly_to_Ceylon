                      ...
                      <div class="row">
                         <div class="col-lg-8 d-none d-lg-block">
                            <div class="header-contact-info">
                               <ul>
                                  <li>
                                     <a href="#"><i class="fas fa-phone-alt"></i> + (77) 2599 12</a>
                                  </li>
                                  <li>
                                     <a href="mailto:info@Travel.com"><i class="fas fa-envelope"></i> FlytoCeylon@gmail.com</a>
                                  </li>
                                  <li>
                                     <i class="fas fa-map-marker-alt"></i> 3146 Colombo, Sri-Lanka
                                  </li>
                               </ul>
                            </div>
                         </div>
                            ...
                            <ul>
                              ...
                              <li class="menu-item-has-children">
                               ...
                               <li class="menu-item-has-children">
                                  ...
                                  <ul> 
                                    <li>
                                       <a href="visiting places.html">Visiting Places</a>
                                    </li>
                                    <!-- <li>
                                    ...
                                    <li>
                                       <a href="Airlines.html">Book an Airlines</a>
                                    </li>  
                                 </li>
                                 </ul>
                            ...
                            -->
                               ...
                               <li class="menu-item-has-children">
                                  ...
                                  <ul>
                                     ...
                                     <li class="menu-item-has-children">
                                        <a href="admin/db-package.html">Your Account</a>
                                        <ul>
                                           <li>
                                           ...
                                           <li>
                                              <a href="admin/db-package-expired.html">Add a Comments</a>
                                           </li>
                                           <li>
                                              <a href="admin/db-package-expired.html">Payment</a>
                                           </li>
