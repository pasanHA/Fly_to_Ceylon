...
<html lang="en">
   <head>
      ...
      <title>Fly to CEYLON | Hotels | Sri Lanka  </title>
   </head>
   <body class="home">
      ...
      <?php require_once ('./php/header.php'); ?>
         <main id="content" class="site-main">
            ...
            <section class="inner-banner-wrap">
               <div class="inner-baner-container" style="background-image: url(assets/images/sl\ h\ 4.jpg);">
                  <div class="container">
                     <div class="inner-banner-content">
                        <h1 class="inner-title">Sri Lanka</h1>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="row">
                     <div class="col-lg-8">
                        <div class="single-tour-inner">
                           <h2>EXPERIENCE THE BEST HOTELS IN SRI LANKA</h2>
                      ...
                      <div class="tab-container">
                              <ul class="nav nav-tabs" id="myTab" role="tablist">
                                 ...
                                 <li class="nav-item">
                                    <a class="nav-link" id="program-tab" data-toggle="tab" href="#program" role="tab" aria-controls="program" aria-selected="false">KANDALAMA</a>
                                 </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="review-tab" data-toggle="tab" href="#review" role="tab" aria-controls="review" aria-selected="false">ANANTHRA</a>
                                 </li>
                                 <li class="nav-item">
                           ...
                           <div class="single-tour-gallery">
                              ...
                              <div class="single-tour-slider">
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="assets/images/sl h 8.jpg" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="assets/images/sl h 5.jpg" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="assets/images/sl h 3.jpg.jpg" alt="">
                                    </figure>
                                 </div>
                                 <div class="single-tour-item">
                                    <figure class="feature-image">
                                       <img src="assets/images/sl.jpg" alt="">
                                    </figure>
                                 </div>
                              </div>
                           </div>
