<?php
 ...
 function componenthotel($img,$dis,$Gid){
    $element = "

                    <div class=\"tab-pane fade show active\" id=\"overview\" role=\"tabpanel\" aria-labelledby=\"overview-tab\">
                    <form action= \"hotel sri lanka.php\" method= \"post\">                 
          ...
          <input type=\"submit\" name=\"submit\" value=\"\"> </div>--> 
           ...
           <!--  btn btn-warning my-3 --> 
                  ...
                  function cartElement1($image, $name, $discription){
                    $element = "
                    ...
                    <form action=\"your package.php\"  method=\"post\" class=\"cart-items\">
                                    <div class=\"border rounded\">
                                         ...
                                         <div class=\"col-md-3 pl-0\">
                                                <img src=\"$image\" alt=\"Ipasamage1er3\" class=\"img-fluid\">
                                         </div>
                                            <div class=\"col-md-6\">
